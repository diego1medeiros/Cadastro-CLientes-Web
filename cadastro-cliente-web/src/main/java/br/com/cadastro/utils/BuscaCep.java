...
/**
 * Classe utilitária que realiza a consulta de endereço com base no CEP,
 * utilizando o serviço gratuito da República Virtual.
 */
@Getter
@Setter
public class BuscaCep {
	...
	/**
	 * Construtor que realiza a busca automática ao instanciar a classe.
	 *
	 * @param cep O CEP no formato 00000000
	 */
